        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "hotel_name",
                    models.CharField(
                        blank=True, help_text="Hotel/Property Name", max_length=255
                    ),
                ),
                (
                    "hotel_address",
                    models.TextField(blank=True, help_text="Hotel Address"),
                ),
                (
                    "hotel_phone",
                    models.CharField(
                ...
                (
                    "hotel_website",
                    models.URLField(blank=True, help_text="Hotel Website URL"),
                ),
                (
                    "hotel_description",
                    models.TextField(blank=True, help_text="Hotel Description"),
                ),
                (
                    "check_in_time",
                    models.CharField(
                        default="14:00",
                        help_text="Check-in Time (e.g., 14:00)",
                        max_length=10,
                    ),
                ),
                (
                    ...
                    models.CharField(
                        default="11:00",
                        help_text="Check-out Time (e.g., 11:00)",
                        max_length=10,
                    ),
                ),
                (
                    "cancellation_policy",
                    models.TextField(blank=True, help_text="Cancellation Policy"),
                ),
                (
                    "early_checkin_policy",
                    models.TextField(blank=True, help_text="Early Check-in Policy"),
                ),
                (
                    "late_checkout_policy",
                    models.TextField(blank=True, help_text="Late Check-out Policy"),
                ),
                (
                    "payment_policy",
                    models.TextField(blank=True, help_text="Payment Policy"),
                ),
                (
                    "currency",
                    models.CharField(
                        default="KES", help_text="Default Currency", max_length=10
                    ),
                ),
                (
                    "tax_rate",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "show_till_number",
                    models.BooleanField(
                        default=True, help_text="Show till number on receipts"
                    ),
                ),
                (
                    "show_paybill",
                    models.BooleanField(
                        default=True, help_text="Show paybill number on receipts"
                    ),
                ),
                (
                    "show_account_number",
                    models.BooleanField(
                        default=True, help_text="Show account number on receipts"
                    ),
                ),
                (
                    "show_payment_details_on_receipt",
                    models.BooleanField(
                        default=True, help_text="Show payment details on receipt"
                    ),
                ),
                ...
                (
                    ...
                    models.CharField(default="KSh", max_length=10),
                ),
                (
                    "currency_position",
                    models.CharField(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "show_vat_on_receipt",
                    models.BooleanField(
                        default=False, help_text="Show VAT/Tax breakdown on receipt"
                    ),
                ),
                (
                    "vat_rate",
                ...
                (
                    ...
                    models.CharField(
                        default="VAT",
                        help_text="Label for tax (e.g., VAT, GST, TAX)",
                        max_length=20,
                    ),
                ),
                (
