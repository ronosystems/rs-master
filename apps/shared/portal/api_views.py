...
def process_payment(request):
    ...
    # ✅ FIXED: Let the model generate the invoice number
    ...
    try:
            ...
            if item.get('type') == 'product' and not is_single:
                ...
                try:
                    ...
                    if product_unit:
                        ...
                        product_unit.current_owner = None  # ✅ Clear owner
                        product_unit.save()
        ...
        if getattr(settings, 'OFFLINE_MODE', False):
            try:
                SyncQueue.objects.create(
                    ...
                    data={
                        'id': sale.id,
                        'invoice_no': sale.invoice_no,  # ✅ Use auto-generated
        ...
        return JsonResponse({
            'success': True,
            'sale_id': sale.id,
            'receipt_number': sale.invoice_no,  # ✅ Auto-generated
            'total': total,
