        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "auto_renew",
                    models.BooleanField(
                        default=False, help_text="Automatically renew subscription"
                    ),
                ),
                ("created_at", models.DateTimeField(auto_now_add=True)),
                ("updated_at", models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "max_rooms",
                    models.IntegerField(
                        default=20, help_text="Maximum rooms for Hotel Master"
                    ),
                ),
            ...
            options={
                ...
                "indexes": [
                    models.Index(fields=["code"], name="tenants_sub_code_6c33ea_idx"),
                    models.Index(
                        fields=["is_active"], name="tenants_sub_is_acti_00fc63_idx"
                    ),
                ],
            },
        ),
